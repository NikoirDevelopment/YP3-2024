...
CREATE TABLE "User" (
    ...
    "OrganizationID" INTEGER NOT NULL REFERENCES "Organization" ("OrganizationID") ON DELETE CASCADE,
    "DivisionsID" INTEGER NULL REFERENCES "Divisions" ("DivisionsID") ON DELETE CASCADE,
    "MinDivisionsID" INTEGER REFERENCES "Divisions" ("DivisionsID") ON DELETE CASCADE,
    ...
    "CabinetID" INTEGER NOT NULL REFERENCES "Cabinet" ("CabinetID") ON DELETE CASCADE,
    "Email" VARCHAR(100) NOT NULL,
    "StatusUserID" INTEGER NOT NULL REFERENCES "StatusUser" ("StatusUserID") ON DELETE CASCADE,
...
CREATE TABLE "Calendar" (
    ...
    "StatusCalendarID" INTEGER REFERENCES "StatusCalendar" ("StatusCalendarID") ON DELETE CASCADE,
    "TypeCalendarID" INTEGER REFERENCES "TypeCalendar" ("TypeCalendarID") ON DELETE CASCADE,
